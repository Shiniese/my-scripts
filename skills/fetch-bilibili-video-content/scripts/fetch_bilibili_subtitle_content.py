...
# 通过网站 https://curlconverter.com/python/，自行把curl命令转为python代码，将headers中的cookie设置到环境变量中，以实现可持续化！
if 'BILIBILI_COOKIE' not in os.environ:
    print('请设置环境变量 BILIBILI_COOKIE，cookie 获取方法：通过网站 https://curlconverter.com/python/，自行把curl命令转为python代码，将headers中的cookie设置到环境变量中，以实现可持续化 headers！')
    exit(1)
